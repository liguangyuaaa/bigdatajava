package lgystudy.flink.flink_20210421;

import day2_07_20210328.src.com.atguigu.exer1.MyDate;
import lgystudy.flink.flink_20210413.HotPages;
import lgystudy.flink.flink_20210413.PageViewCount;
import lgystudy.flink.flink_20210420.UserBehavior;
...
public class UvWithBloomFilter {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<UserBehavior> dataStream = inputStream
                .map(line -> {
                    ...
                    return new UserBehavior(new Long(fields[0]), new Long(fields[1]), new Integer(fields[2]),
                            fields[3], new Long(fields[4]));
    ...
    //实现自定义的处理函数
    public static class UvCountResultWithBloomFliter extends ProcessAllWindowFunction<UserBehavior,
            PageViewCount, TimeWindow>{
        //定义jedis连接和布隆过滤器
        Jedis jedis;
        ...
        @Override
        public void process(Context context, java.lang.Iterable<UserBehavior> elements, Collector<PageViewCount> out) throws Exception {
