...
public class HotItems {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> inputStream = env.readTextFile("D:\\BeiJingBigData\\gitcode\\big-data-demo\\src\\main\\java\\lgystudy\\flink\\flink_20210412\\UserBehavior.csv");

        //2.读取数据，创建DataStream
//        Properties properties = new Properties();
//        properties.setProperty("bootstarp.servers","flink01:9092");
...
//                new SimpleStringSchema(), properties));
        ...
        DataStream<UserBehavior> dataStream = inputStream.map(line -> {
            ...
            return new UserBehavior(new Long(fiels[0]), new Long(fiels[1]),
                    new Integer(fiels[2]), fiels[3], new Long(fiels[4]));
