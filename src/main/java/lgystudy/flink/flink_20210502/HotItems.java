...
import lgystudy.flink.flink_20210412.ItemViewCount;
import lgystudy.flink.flink_20210412.UserBehavior;
...
//        properties.setProperty("value.deserializer","org.apache.kafka.common.serizlization.StringDeserializer");
...
//        DataStream<String> inputStream = env.addSource(new FlinkKafkaConsumer<String>("hotitems", new SimpleStringSchema(), properties));
        ...
        DataStream<String> inputStream = env.readTextFile("/opt/UserBehavior.csv");
    ...
    public static class TopNHotItems extends KeyedProcessFunction<Tuple, ItemViewCount, String>{
        ...
        //定义列表状态，保存当前窗口内所有输出的ItemViemCount
